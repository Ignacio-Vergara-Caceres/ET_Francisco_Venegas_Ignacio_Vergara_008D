...
import { UserNuevoGestor } from 'src/interfaces/users';
...
export class CardPage implements OnInit {
  ...
  constructor(private authservice: AuthService, 
    ...
    private fBuilder: FormBuilder) {
      ...
      'rut': new FormControl ("", [Validators.required, Validators.minLength(9),Validators.maxLength(9),Validators.pattern("^[0-9]+[0-9Kk]{1}$")]),
